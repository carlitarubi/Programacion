...
if ($conexion->connect_errno) {
  ...
  $resultado = $conexion->query("SELECT nombre, puntuacion FROM usuario");
}
 ?>
<!DOCTYPE html>
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <!-- <div class="fila"> <p>Siguiente fila <input type="text" name="Fila" autocomplete="off"></div></p>
    <div class="columna"><p> Siguiente columna<input type="text" name="Columna" autocomplete="off"> </div></p></div>
    <br>
    <div class=""> <p>Mensajes</p></div> -->
